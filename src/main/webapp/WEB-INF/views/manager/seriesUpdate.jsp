    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form method="POST" id="frmSerires" action="${pageContext.request.contextPath}/manager/seriesUpdateOk.do" enctype="multipart/form-data" class="form-horizontal form-material">
                <input type="hidden" name="sr_uid" value="${series.sr_uid }">
                <!-- .row -->
                    ...
                    <div class="white-box">
     		            <div class="col-md-4 col-xs-12">
		                    <div class="white-box">
		                        ...
		                        <div class="user-bg"><img id="goodsImg" style="max-width:300px;" width="100%" height="100%" alt="goods" src="${pageContext.request.contextPath}/img/goods/${series.sr_img}"></div>
		                ...
		                <div class="col-md-8 col-xs-12">
		                    <div class="white-box">
			                    <div class="form-group">
			                        ...
			                        <div class="col-md-12">
			                            <input type="text" name="sr_name" placeholder="name" class="form-control form-control-line" value="${series.sr_subject}" required> </div>
			                    </div>
		                     <div class="clear"></div>
		                    </div>
		                </div>
                    ...
                    <div class="white-box" id="components">
	                	<div class="col-md-12">
	                           ...
	                           <table class="table" id="compoTable">
	                               ...
	                               <tbody>
	                               <c:forEach var="goods" items="${series.goodsList}" varStatus="status">
	                                   <tr id="compo${goods.g_uid }">
	                                       <td>${goods.g_name}</td>
	                                       <script>
	                                           $(document).ready(function(){
	                                        	   var gtype = parseType(${goods.g_type});
	                                        	   $("td#type" + ${goods.g_uid}).html(gtype);
	                                           });
	                                       </script>
	                                       <td id="type${goods.g_uid}"></td>
	                                       <td>${goods.g_price}</td>
	                                       <td><button onclick='minusToCompoTable(${goods.g_uid})' class='btn btn-danger m-l-20 btn-circle btn-outline waves-effect waves-light'><i class='fa fa-minus' aria-hidden='true'></i></button></td>
	                                       <td><input type="hidden" name="uid" value="${goods.g_uid}"></td>
	                                   </tr>
	                               </c:forEach>
	                               </tbody>
	                           </table>
